                        ...
                        <div class="col-sm-6 col-md-4">
                          <div class="thumbnail">
                            ...
                            <div class="caption">
                              ...
                              <p>{{$s->descripcion}}</p>
                                @if (Auth::user())
                                    <a class="btn btn-info btn-sm pull-right" href="#" Onclick='Ordenar({{$s->id}});' data-toggle='modal' data-target='#myModalSolicitar' style="margin-top: -60px;">Solicitar</a>

                                     <div style="margin-top: -50px; margin-left: 170px;" class="fb-share-button pull-left"  data-layout="button" data-size="small" data-mobile-iframe="true">
                                ...
                                @else
                                   <a class="btn btn-info btn-sm pull-right" href="#" style="margin-top: -60px;" data-toggle='modal' data-target='#myModalSolicitar2'>Solicitar</a>
